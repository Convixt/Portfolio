      ...
      >
        ...
        <div className="pb-10">
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hi, I'm <span className='text-[#915EFF]'>Nishith</span>
          </h1>
          <p className={`${styles.heroSubText} mt-2 mb-50 text-white-100`}>
          Enthusiastic MERN Stack Developer  <br className='sm:block hidden' />
          crafting dynamic websites with a passion for seamless user experiences.
